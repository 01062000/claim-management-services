...
import com.cts.policy.cms.exception.InvalidTokenException;
...
public class PolicyMicroserviceController {
	...
	public String getBenefitsIds(@PathVariable String benefitName, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
	...
	public String getHospitalsIds(@PathVariable String name, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		if (!authClient.authorizeTheRequest(token)) {
			throw new InvalidTokenException(msg);
		}
	...
	public String getPolicyIds(@PathVariable String policyType, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		if (!authClient.authorizeTheRequest(token)) {
			throw new InvalidTokenException(msg);
		}
	...
	public List<Benefits> getAllBenefitsDetails(@RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		if (!authClient.authorizeTheRequest(token)) {
			throw new InvalidTokenException(msg);
		}
	...
	public List<Hospital> getAllHospitalsDetails(@RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		if (!authClient.authorizeTheRequest(token)) {
			throw new InvalidTokenException(msg);
		}
	...
	public List<Policy> getAllPoliciesDetails(@RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		if (!authClient.authorizeTheRequest(token)) {
			throw new InvalidTokenException(msg);
		}
	...
	public ResponseEntity<Provider> getChainOfProviders(@PathVariable String policyId, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
	...
	public ResponseEntity<ListOfBenefits> getEligibleBenefits(@PathVariable String policyId, @PathVariable String memberId, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
	...
	public ResponseEntity<ClaimAmount> getEligibleAmount(@PathVariable String policyId, @PathVariable String memberId, @RequestHeader(name = "Authorization", required = true)String token) throws InvalidTokenException{
		log.info("Inside get eligible benefits");
			if (!authClient.authorizeTheRequest(token)) {										
				throw new InvalidTokenException(msg);
		}	   
